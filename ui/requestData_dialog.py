...
#
# Created: Wed Oct 12 10:47:37 2016
...
class Ui_requestData_dialog(object):
    def setupUi(self, requestData_dialog):
        ...
        requestData_dialog.resize(347, 246)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.num_parcel_lbl)
        self.num_parcel_tbx = QtGui.QLineEdit(requestData_dialog)
        self.num_parcel_tbx.setObjectName(_fromUtf8("num_parcel_tbx"))
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.num_parcel_tbx)
        self.area_lbl = QtGui.QLabel(requestData_dialog)
        self.area_lbl.setObjectName(_fromUtf8("area_lbl"))
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.area_lbl)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.area_dsb)
        self.diaEdicion_chb = QtGui.QCheckBox(requestData_dialog)
        self.diaEdicion_chb.setObjectName(_fromUtf8("diaEdicion_chb"))
        self.formLayout.setWidget(5, QtGui.QFormLayout.LabelRole, self.diaEdicion_chb)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.diaEdicion_de)
        self.deleg_lbl = QtGui.QLabel(requestData_dialog)
        self.deleg_lbl.setObjectName(_fromUtf8("deleg_lbl"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.deleg_lbl)
        self.muni_lbl = QtGui.QLabel(requestData_dialog)
        self.muni_lbl.setObjectName(_fromUtf8("muni_lbl"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.muni_lbl)
        self.deleg_tbx = QtGui.QLineEdit(requestData_dialog)
        self.deleg_tbx.setObjectName(_fromUtf8("deleg_tbx"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.deleg_tbx)
        self.muni_tbx = QtGui.QLineEdit(requestData_dialog)
        self.muni_tbx.setObjectName(_fromUtf8("muni_tbx"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.muni_tbx)
    ...
    def retranslateUi(self, requestData_dialog):
        ...
        self.deleg_lbl.setText(_translate("requestData_dialog", "Delegación", None))
        self.muni_lbl.setText(_translate("requestData_dialog", "Municipio", None))
